...
import uk.co.apalis.myapplication.view.CameraPreview;
import uk.co.apalis.myapplication.view.CameraSurfaceView;
...
public class AndroidCamera extends Activity {
    ...
    public void resizeBtnTakePic(int width, int height) {
        ViewGroup.LayoutParams pr = buttonTakePicture.getLayoutParams();
