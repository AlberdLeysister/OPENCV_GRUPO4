...
import uk.co.apalis.myapplication.utils.CharDetectOCR;
import uk.co.apalis.myapplication.utils.CommonUtils;
import uk.co.apalis.myapplication.view.TouchImageView;

import static uk.co.apalis.myapplication.utils.CommonUtils.info;
...
public class RecognizeTextActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnStartCamera.setOnTouchListener(new View.OnTouchListener() {
